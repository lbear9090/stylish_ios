...
@interface JTSImageViewController : UIViewController<ESItemTagViewDelegate>
...
///--------------------------------------------------------------------------------------------------------------------
/// custom variables --- binocular button
///--------------------------------------------------------------------------------------------------------------------

@property (strong, nonatomic) IBOutlet UIButton *btnBinocular;
@property (assign) BOOL selectBinocular;
@property (strong, nonatomic) NSMutableArray *arrRealPosition;
@property (strong, nonatomic) ESItemTagView  *itemView;
@property (strong, nonatomic) NSMutableArray *arrItemView;
@property (strong, nonatomic) UIImage        *originalImage;



//@property (strong, nonatomic) NSMutableArray *arrOwnLabel;
@property (strong, nonatomic) NSString       *selectedPhotoPostId;
@property (strong, nonatomic) PFUser         *selectedPostingUser;
@property (strong, nonatomic) NSMutableArray *arrSelectedItemObjectIdAndName;
