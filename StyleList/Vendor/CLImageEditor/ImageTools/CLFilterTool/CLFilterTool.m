...
//    if (self.editor.bImage == nil) {
    _originalImage = [self renderWholeImageView:self.editor.imageView];
//    } else {
//        _originalImage = self.editor.bImage;
//    }
...
- (void)executeWithCompletionBlock:(void (^)(UIImage *, UIImage *,UIBezierPath *drawPath, NSError *, NSDictionary *))completionBlock
{
    completionBlock(self.editor.imageView.image, nil,nil, nil, nil);
}
