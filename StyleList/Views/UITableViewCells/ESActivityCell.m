...
- (void)setActivity:(PFObject *)activity {
    ...
    _activity = activity;
    if ([[activity objectForKey:kESActivityTypeKey] isEqualToString:kESActivityTypeFollow] || [[activity objectForKey:kESActivityTypeKey] isEqualToString:kESActivityTypeJoined] || [[activity objectForKey:kESActivityTypeKey] isEqualToString:kESActivityTypeMention] || [[activity objectForKey:kESActivityTypeKey] isEqualToString:kESActivityTypeMentionPost]) {
