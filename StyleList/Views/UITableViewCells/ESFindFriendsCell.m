...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.nameButton.titleLabel.font = [UIFont fontWithName:GTWALSHEIM_REGULAR_FONT size:16.0f];
        ...
        self.photoLabel.font = [UIFont fontWithName:GTWALSHEIM_REGULAR_FONT size:11.0f];;
        ...
        self.followButton.titleLabel.font = [UIFont fontWithName:GTWALSHEIM_REGULAR_FONT size:15.0f];;
...
- (void)setUser:(PFUser *)aUser {
    ...
    CGSize photoLabelSize = [@"photos" boundingRectWithSize:CGSizeMake([UIScreen mainScreen].bounds.size.width/2, CGFLOAT_MAX)
                                                 ...
                                                 attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:11.0f]}
                                                    context:nil].size;
    [photoLabel setFrame:CGRectMake( 62.0f, 20.0f + nameSize.height, 140.0f, photoLabelSize.height)];
