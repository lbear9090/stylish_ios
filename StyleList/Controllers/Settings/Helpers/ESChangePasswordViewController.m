...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            tf.font = [UIFont fontWithName:GTWALSHEIM_REGULAR_FONT size:16.0f];
            ...
            tf2.font = [UIFont fontWithName:GTWALSHEIM_REGULAR_FONT size:16.0f];
            ...
            tf3.font = [UIFont fontWithName:GTWALSHEIM_REGULAR_FONT size:16.0f];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 0) {
        ...
        label.font = [UIFont fontWithName:GTWALSHEIM_REGULAR_FONT size:15.0f];
