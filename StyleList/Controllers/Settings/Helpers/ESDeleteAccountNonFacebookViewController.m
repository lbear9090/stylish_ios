            ...
            if ([[currentUser objectForKey:@"username"] isEqualToString:[tf text]]) {
                ...
                [PFUser logInWithUsernameInBackground:tf.text password:tf2.text block:^(PFUser *user, NSError *error) {
                    ...
                    if (error) {
                        ...
                        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:NSLocalizedString(@"Error", nil) message:NSLocalizedString(@"Wrong username or password. Try again or contact us.",nil) delegate:self cancelButtonTitle:NSLocalizedString(@"OK", nil) otherButtonTitles: nil];
                        [alert show];
                ...
                [MBProgressHUD hideHUDForView:self.view animated:YES];
                UIAlertView *alert = [[UIAlertView alloc]initWithTitle:NSLocalizedString(@"Error", nil) message:NSLocalizedString(@"An error occurred, while tryying to delete your user. Try again or contact us.",nil) delegate:self cancelButtonTitle:NSLocalizedString(@"OK", nil) otherButtonTitles: nil];
                [alert show];
