...
/**
 *  TextField containing the user's your style. Editable.
 */
@property (nonatomic, strong) UITextField *yourStyleTextField;
/**
 *  TextField containing the user's email. Editable.
 */
@property (nonatomic, strong) UITextField *emailTextField;
/**
 *  TextField containing the user's paypal address Editable.
 */
@property (nonatomic, strong) NonPasteUITextField *paypalTextField;
/**
 *  TextField containing the user's country address Editable.
 */
 ...
 *  Save button in the navigation bar. When tapped, we check if the necessary information has been provided and the email is correct and then we save the user.
 */
@property (nonatomic, strong) UIBarButtonItem *doneInfoBtn;
/**
...
/**
 *  PickerView used to choose the country of the user.
 */
@property (nonatomic, strong) UIPickerView *countryPicker;

/**
 *  string variables of all items .
 */
@property (strong, nonatomic) NSString *strUserName;
@property (strong, nonatomic) NSString *strMention;
...
@property (strong, nonatomic) NSString *strPaypal;
...
/**
 *  Called when the gender has been picked, filling out the countryTextField programmatically.
 */
