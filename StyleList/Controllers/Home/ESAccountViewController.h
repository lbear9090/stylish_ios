...
@interface ESAccountViewController : ESPhotoTimelineAccountViewController <UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource>{
...
/**
 *  Button taking the user to his edit style page. It shows only
    on own user's profile.
 */
@property (nonatomic, strong) UIButton *editStyleBtn;
/**
 * Photo List, Filter Button.
 */
@property (nonatomic, strong) UIButton *btnList;
@property (nonatomic, strong) UIButton *btnFilter;
@property (nonatomic, strong) UIView   *filterView;
/**
 *  Button taking the user to private messages
 */
@property (nonatomic, strong) UIButton *privateMessageBtn;
...
@property (nonatomic, strong) UIButton *forSaleBtn;
@property (nonatomic, strong) UIButton *forHireBtn;
@property (strong, nonatomic) NSMutableArray<PFObject *> *tempObject;
...
/**
 *  Called when the edit Style button is tapped .
 */
