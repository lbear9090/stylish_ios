...
static PFQuery * extracted(PFQuery *photosFromSearchedHashtag, PFQuery *searchedHashtagQuery) {
    return [photosFromSearchedHashtag whereKey:kESUserObjectIdKey matchesKey:kESUserPhotoIDKey inQuery:searchedHashtagQuery];
}
...
- (PFQuery *)queryForTable {
    ...
    extracted(photosFromSearchedHashtag, searchedHashtagQuery);
