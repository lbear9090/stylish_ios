...
@interface ESBestViewController () {
    float previousAmount2;
    
}
@end

@implementation ESBestViewController
...
- (void)viewDidLoad {
    self.title = @"Most successful ever";
...
- (void)objectsDidLoad:(NSError *)error {
    ...
    if ([self.objects count] > 0) {
        ...
        labelView.text = @"No highscore posts";
